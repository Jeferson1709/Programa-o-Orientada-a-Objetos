...
public class TestaObjetos {
	public static void main(String[] args) {
		...
		c2.depositar(500);
		// Passa para a variável c3 a mesma referência da variável c2
		ContaBancaria c3 = c2;
		...
		cl2.setNome("Maria");
		// Passa para a variável cl3 a mesma referência da variável cl1
		Cliente cl3 = cl1;
		// associa os clientes as contas, lembrando que c2 e c3 são as mesmas contas
		c1.setCliente(cl1);
		c2.setCliente(cl2);
		c3.setCliente(cl3);
		// troca o nome do cliente da conta cl3, que não a mesma que a cl2
		cl3.setNome("Alberto");
